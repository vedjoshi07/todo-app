...
export function EmptyState({ filter }: Props) {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center px-6 py-20 animate-fade-in">
      <Illustration />
      <h3 className="mt-6 text-lg font-semibold text-[#0F172A]">{m.title}</h3>
